            ...
            children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            width: 120,
                            color: Colors.white,
                            child: Image.asset('Shoe2.png',fit: BoxFit.cover,),
                          ),
                      ...
                      child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              width: 120,
                              color: Colors.white,
                              child: Image.asset('Perfumee.png',fit: BoxFit.fill,),
                            ),
                            Text('Perfume',style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 20,
                            ),),
                            Row(
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    IconButton(onPressed: (){}, icon: Icon(Icons.home,color: Colors.grey,size: 35,)),
                    IconButton(onPressed: (){}, icon: Icon(Icons.shopping_bag,color: Colors.grey,size: 35,)),
                    IconButton(onPressed: (){}, icon: Icon(Icons.account_circle_rounded,color: Colors.yellow,size: 50,)),
